...
tmp_dir="updateCorrelationTemp"
final_output_dir="updateCorrelationOutput"
...
./bin/collectCorrelation -logfiles="$path_to_trace" -outputdir="$tmp_dir" -distances="$distances" -starts="$starts_blocks" -ends="$ends_blocks" -optype="Update"
